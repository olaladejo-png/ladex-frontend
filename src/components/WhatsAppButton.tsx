...
const INSTAGRAM_URL = 'https://www.instagram.com/ladexgroup_?igsh=NG44dTlpdGw2dXZw&utm_source=qr';

export default function WhatsAppButton({ linkedinUrl = "http://linkedin.com/in/iyiola-ladejo", whatsappUrl = "https://wa.me/4915218162816" }: { linkedinUrl?: string, whatsappUrl?: string }) {
  return (
    <>
      <style>{`
        .floating-buttons {
        ...
        .ig-btn { background: linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888); box-shadow: 0 4px 20px rgba(220,39,67,0.4); }
        .ig-btn:hover { box-shadow: 0 6px 28px rgba(220,39,67,0.55); }
