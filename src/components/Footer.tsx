...
export default function Footer({ settings }: FooterProps) {
  ...
  const whatsappDE = '+4915218162816';
  const phoneDE = settings?.contact_phone || '+49 1521 816 2816';
  const phoneNG = '+2347040580988';
  const linkedin = settings?.linkedin_url || 'http://linkedin.com/in/iyiola-ladejo';
            ...
            <div className="footer-grid">
              ...
              <div>
                ...
                <div className="footer-socials">
                  ...
                  <a href={`https://wa.me/${whatsappDE}`} target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="WhatsApp" title="WhatsApp">
